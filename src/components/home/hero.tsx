    ...
    <section className="border-b border-stone-200 bg-hero-glow">
      <div className="container-shell py-10 sm:py-14 lg:py-16">
        <div className="editorial-grid items-stretch lg:h-[760px]">
          ...
          <div className="mt-10 flex min-h-[72px] flex-wrap items-center gap-4">
            <Button href="/categoria/criados-mudos" size="lg">
              Conheça a coleção
            </Button>
            {activeProduct ? (
              <div className="max-w-full truncate rounded-full border border-stone-200 bg-stone-50 px-4 py-2 text-sm text-stone-700 sm:max-w-[270px]">
        ...
        <div className="order-1 overflow-hidden lg:order-2 lg:h-[760px]">
          {activeProduct ? (
            <div className="relative h-[420px] overflow-hidden bg-[#d9c8b9] sm:h-[540px] lg:h-full">
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/50 via-black/10 to-transparent p-4 sm:p-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                  <div className="min-h-[154px] text-white sm:min-h-[164px]">
                    <p className="text-xs uppercase tracking-[0.28em] text-white/75">Coleção Atlas</p>
                    <h2 className="mt-2 min-h-[76px] max-w-[12ch] font-serif text-3xl leading-[1.02] sm:min-h-[84px] sm:text-4xl">
                      {activeProduct.name}
                    </h2>
                ...
                <div className="-mx-1 mt-5 flex gap-2 overflow-x-auto px-1 pb-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                  {products.map((product, productIndex) => (
                    <button
                      className={cn(
                        "shrink-0 whitespace-nowrap rounded-full border px-3 py-2 text-xs uppercase tracking-[0.22em] backdrop-blur transition",
                        productIndex === index
